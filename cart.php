        ...
        <div class="container">
            ...
            <?php } else { ?>
                ...
                <form id="cart-form" action="cart.php?action=submit" method="POST">
                    ...
                    <hr>
                    <div><label>Người nhận: </label><input type="text" value="" name="txt_ship_fullname" /></div>
                    <div><label>Email: </label><input type="text" value="" name="txt_ship_email" /></div>
                    <div><label>Điện thoại: </label><input type="text" value="" name="txt_ship_mobile" /></div>
                    <div><label>Địa chỉ: </label><input type="text" value="" name="txt_ship_addr1" /></div>
                    <div><label>Ghi chú: </label><textarea name="note" cols="50" rows="7" ></textarea></div>
                    <div><label>Tổng tiền: </label><input class="form-control" id="amount" name="amount" type="number" value ="<?php echo (int)$total ;?>" disabled/></div><br><br>
